...
multi_pred %>% 
  ...
  labs(title = "prediction accuracy according to age_crude")
```
We make a plot to show the prediction accuracy of or multinomial logistic model with respect to age_crude. 