...
## Abstract ##
Even though can be effectively prevented by vaccine, [Hepatitis B](https://www.cdc.gov/hepatitis/hbv/index.htm) currently is still a problem need to be cared. It highly risky for infant to develop chronic infection from HBV, whereas only 2%-6% of adults may get chronically infected. The best way to prevent HBV is to get vaccinated [[1](https://www.cdc.gov/hepatitis/hbv/index.htm)]. As it is obvious that Hepatitis B vaccinated ratio varies in different communities, our group would like to find what factors can be statistically significantly related to Hepatitis B Vaccinated condition. Data related to vaccinate condition was chosen from [CDC's National Health and Nutrition Examination Survery website](https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_HIQ.htm) from 2017 to March 2020 and cleaned. Logistic regression model was built to show the relationship with the variables. The final result showed that the age, gender, race, education level and insurance coverage have statistically significantly associated with Hepatitis B vaccinate condition. The model obtained was: __model = glm(formula = hepbvax ~ agecrude + gender + race + educat + insany, family = binomial())__.

## Introduction ## 
Hepatitis B virus, though currently not a big problem, still caused a total 21600 cases of acute infection [[2](https://www.cdc.gov/hepatitis/hbv/hbvfaq.htm#overview)]. Thanks to Hepatitis B vaccine, the ration of new HBV infections in United state maintained constantly around 1 reported cases per 100 thousand population from 2011 to 2018 [[2](https://www.cdc.gov/hepatitis/hbv/hbvfaq.htm#overview)]. However, there are still 880 thousand to 1.89 million people are living with HBV infection [[3](https://pubmed.ncbi.nlm.nih.gov/34097776/),[4](https://pubmed.ncbi.nlm.nih.gov/33655536/)]. Non-US-born people, who accounts for 14% of the US general population, account for 69 % of the Us population living with chronic HBV infection. This reminds us that HBV infection may vary greatly in different communities [[2](https://www.cdc.gov/hepatitis/hbv/hbvfaq.htm#overview)]. 
